...
static int ml_append_int(buf_T *buf, linenr_T lnum, char_u *line, colnr_T len, _Bool newfile, int mark);
...
static _Bool fnamecmp_ino(char_u *fname_c, char_u *fname_s, long ino_block0);
