...
static char *did_set_string_option(int opt_idx, char_u **varp, _Bool new_value_alloced, char_u *oldval, char *errbuf, size_t errbuflen, int opt_flags, int *value_checked);
static int int_cmp(const void *a, const void *b);
static int get_encoded_char_adv(char_u **p);
static char *set_chars_option(win_T *wp, char_u **varp, _Bool set);
static char *did_set_spell_option(_Bool is_spellfile);
static char *compile_cap_prog(synblock_T *synblock) FUNC_ATTR_NONNULL_ALL;
