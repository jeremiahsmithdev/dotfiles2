...
static int ex_let_vars(char_u *arg_start, typval_T *tv, int copy, int semicolon, int var_count, int is_const, char_u *op);
...
static int eval_func(char_u **const arg, char_u *const name, const int name_len, typval_T *const rettv, const _Bool evaluate, typval_T *const basetv) FUNC_ATTR_NONNULL_ARG(1, 2, 4);
...
static int eval7_leader(typval_T *const rettv, const char_u *const start_leader, const char_u **const end_leaderp) FUNC_ATTR_NONNULL_ALL;
static int call_func_rettv(char_u **const arg, typval_T *const rettv, const _Bool evaluate, dict_T *const selfdict, typval_T *const basetv, const char_u *const lua_funcname) FUNC_ATTR_NONNULL_ARG(1, 2);
static int eval_lambda(char_u **const arg, typval_T *const rettv, const _Bool evaluate, const _Bool verbose) FUNC_ATTR_NONNULL_ALL;
static int eval_method(char_u **const arg, typval_T *const rettv, const _Bool evaluate, const _Bool verbose) FUNC_ATTR_NONNULL_ALL;
