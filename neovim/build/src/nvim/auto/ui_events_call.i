# 1 "/home/jesmith/neovim/build/src/nvim/auto/ui_events_call.generated.h"
# 1 "<built-in>"
# 1 "<command-line>"
...
void ui_call_tabline_update(Tabpage current, Array tabs, Buffer current_buffer, Array buffers)
{
  ...
  ADD(args, BUFFER_OBJ(current_buffer));
  ADD(args, ARRAY_OBJ(buffers));
