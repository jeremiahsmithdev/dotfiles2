...
Object handle_nvim__buf_redraw_range(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim__buf_redraw_range", channel_id);
#endif
  Object ret = NIL;
  Buffer arg_1;
  Integer arg_2;
...
Object handle_nvim_buf_del_mark(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_buf_del_mark", channel_id);
#endif
  Object ret = NIL;
  Buffer arg_1;
  String arg_2;
...
Object handle_nvim_buf_set_mark(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_buf_set_mark", channel_id);
#endif
  Object ret = NIL;
  Buffer arg_1;
  String arg_2;
...
Object handle_nvim__runtime_inspect(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim__runtime_inspect", channel_id);
#endif
  Object ret = NIL;
...
Object handle_nvim__get_runtime(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim__get_runtime", channel_id);
#endif
  Object ret = NIL;
  Array arg_1;
  Boolean arg_2;
...
Object handle_nvim_del_mark(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_del_mark", channel_id);
#endif
  Object ret = NIL;
  String arg_1;
...
Object handle_nvim_get_mark(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_get_mark", channel_id);
#endif
  Object ret = NIL;
  String arg_1;
  Dictionary arg_2;
...
Object handle_nvim_eval_statusline(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_eval_statusline", channel_id);
#endif
  Object ret = NIL;
  String arg_1;
...
void msgpack_rpc_init_method_table(void)
{
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim__buf_redraw_range", .size = sizeof("nvim__buf_redraw_range") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim__buf_redraw_range, .fast = false});
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim_buf_del_mark", .size = sizeof("nvim_buf_del_mark") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_buf_del_mark, .fast = false});
  msgpack_rpc_add_method_handler((String) {.data = "nvim_buf_set_mark", .size = sizeof("nvim_buf_set_mark") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_buf_set_mark, .fast = false});
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim__runtime_inspect", .size = sizeof("nvim__runtime_inspect") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim__runtime_inspect, .fast = false});
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim__get_runtime", .size = sizeof("nvim__get_runtime") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim__get_runtime, .fast = true});
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim_del_mark", .size = sizeof("nvim_del_mark") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_del_mark, .fast = false});
  msgpack_rpc_add_method_handler((String) {.data = "nvim_get_mark", .size = sizeof("nvim_get_mark") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_get_mark, .fast = false});
  msgpack_rpc_add_method_handler((String) {.data = "nvim_eval_statusline", .size = sizeof("nvim_eval_statusline") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_eval_statusline, .fast = true});
