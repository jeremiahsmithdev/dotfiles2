...
static void frame_new_height(frame_T *topfrp, int height, _Bool topfirst, _Bool wfh) FUNC_ATTR_NONNULL_ALL;
...
static void last_status_rec(frame_T *fr, _Bool statusline);
