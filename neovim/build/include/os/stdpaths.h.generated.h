...
DLLEXPORT char *stdpaths_user_data_subpath(const char *fname, const size_t trailing_pathseps, const _Bool escape_commas) FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL FUNC_ATTR_NONNULL_RET;
#include "nvim/func_attr.h"
