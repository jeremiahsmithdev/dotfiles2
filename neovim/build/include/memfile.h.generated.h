...
#  endif
#endif
DLLEXPORT memfile_T *mf_open(char_u *fname, int flags);
DLLEXPORT int mf_open_file(memfile_T *mfp, char_u *fname);
...
DLLEXPORT void mf_set_fnames(memfile_T *mfp, char_u *fname);
