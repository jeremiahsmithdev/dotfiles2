...
#  endif
#endif
DLLEXPORT Dictionary nvim_get_hl_by_name(String name, Boolean rgb, Error *err) FUNC_API_SINCE(3);
DLLEXPORT Dictionary nvim_get_hl_by_id(Integer hl_id, Boolean rgb, Error *err) FUNC_API_SINCE(3);
DLLEXPORT Integer nvim_get_hl_id_by_name(String name) FUNC_API_SINCE(7);
DLLEXPORT Dictionary nvim__get_hl_defs(Integer ns_id, Error *err);
DLLEXPORT void nvim_set_hl(Integer ns_id, String name, Dictionary val, Error *err) FUNC_API_SINCE(7);
DLLEXPORT void nvim__set_hl_ns(Integer ns_id, Error *err) FUNC_API_FAST;
DLLEXPORT void nvim_feedkeys(String keys, String mode, Boolean escape_csi) FUNC_API_SINCE(1);
...
DLLEXPORT Object nvim_get_option(String name, Error *err) FUNC_API_SINCE(1);
...
DLLEXPORT void nvim_echo(Array chunks, Boolean history, Dictionary opts, Error *err) FUNC_API_SINCE(7);
...
DLLEXPORT void nvim_set_keymap(String mode, String lhs, String rhs, Dict(keymap) *opts, Error *err) FUNC_API_SINCE(6);
DLLEXPORT void nvim_del_keymap(String mode, String lhs, Error *err) FUNC_API_SINCE(6);
DLLEXPORT Dictionary nvim_get_commands(Dict(get_commands) *opts, Error *err) FUNC_API_SINCE(4);
DLLEXPORT Array nvim_get_api_info(uint64_t channel_id) FUNC_API_SINCE(1) FUNC_API_FAST FUNC_API_REMOTE_ONLY;
...
DLLEXPORT Array nvim_call_atomic(uint64_t channel_id, Array calls, Error *err) FUNC_API_SINCE(1) FUNC_API_REMOTE_ONLY;
...
DLLEXPORT Array nvim__inspect_cell(Integer grid, Integer row, Integer col, Error *err);
