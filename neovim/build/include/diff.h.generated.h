...
DLLEXPORT void diff_mark_adjust(linenr_T line1, linenr_T line2, long amount, long amount_after);
DLLEXPORT void diff_redraw(_Bool dofold);
DLLEXPORT int diff_internal(void);
...
DLLEXPORT _Bool diffopt_hiddenoff(void);
