...
DLLEXPORT void do_shell(char_u *cmd, int flags);
DLLEXPORT char_u *make_filter_cmd(char_u *cmd, char_u *itmp, char_u *otmp);
...
DLLEXPORT int rename_buffer(char_u *new_fname);
...
DLLEXPORT int check_overwrite(exarg_T *eap, buf_T *buf, char_u *fname, char_u *ffname, int other);
DLLEXPORT void ex_wnext(exarg_T *eap);
DLLEXPORT void do_wqall(exarg_T *eap);
DLLEXPORT int not_writing(void);
DLLEXPORT int getfile(int fnum, char_u *ffname_arg, char_u *sfname_arg, int setpm, linenr_T lnum, int forceit);
DLLEXPORT int do_ecmd(int fnum, char_u *ffname, char_u *sfname, exarg_T *eap, linenr_T newlnum, int flags, win_T *oldwin);
DLLEXPORT void ex_append(exarg_T *eap);
DLLEXPORT void ex_change(exarg_T *eap);
DLLEXPORT void ex_z(exarg_T *eap);
DLLEXPORT int check_secure(void);
...
DLLEXPORT void global_exe(char_u *cmd);
DLLEXPORT _Bool prepare_tagpreview(_Bool undo_sync);
DLLEXPORT void ex_help(exarg_T *eap);
DLLEXPORT char_u *check_help_lang(char_u *arg);
DLLEXPORT int help_heuristic(char_u *matched_string, int offset, int wrong_case);
DLLEXPORT int find_help_tags(const char_u *arg, int *num_matches, char_u ***matches, _Bool keep_lang);
...
DLLEXPORT int sub_preview_win(buf_T *preview_buf);
DLLEXPORT void close_preview_windows(void);
DLLEXPORT void ex_substitute(exarg_T *eap);
DLLEXPORT char_u *skip_vimgrep_pat(char_u *p, char_u **s, int *flags);
