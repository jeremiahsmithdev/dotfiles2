...
DLLEXPORT int foldLevel(linenr_T lnum);
...
DLLEXPORT void foldMarkAdjust(win_T *wp, linenr_T line1, linenr_T line2, long amount, long amount_after);
DLLEXPORT int getDeepestNesting(win_T *wp);
DLLEXPORT char_u *get_foldtext(win_T *wp, linenr_T lnum, linenr_T lnume, foldinfo_T foldinfo, char_u *buf) FUNC_ATTR_NONNULL_ARG(1);
DLLEXPORT void foldtext_cleanup(char_u *str);
