...
DLLEXPORT _Bool buf_updates_active(buf_T *buf);
...
DLLEXPORT void buf_updates_send_changes(buf_T *buf, linenr_T firstline, int64_t num_added, int64_t num_removed, _Bool send_tick);
